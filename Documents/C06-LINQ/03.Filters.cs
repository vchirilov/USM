//*******************************************************************************************
//Filters allow data to be filtered by some criteria. Keyword where is used to filter data
//*******************************************************************************************
    ...
    class Filter
    {
        ...
        public static void RunFilterComplexObject()
        {
            List<User> users = new List<User>{
                new User {Name="Tom", Age=23, Languages = new List<string> {"english", "немецкий" }},
                new User {Name="Boby", Age=27, Languages = new List<string> {"english", "french" }},
                new User {Name="Jhon", Age=29, Languages = new List<string> {"english", "испанский" }},
                new User {Name="Marta", Age=24, Languages = new List<string> {"испанский", "german" }}
            };
